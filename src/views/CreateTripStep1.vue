...
<template>
  <div class="flex min-h-screen flex-col bg-gray-50">
    <div class="mx-auto w-full max-w-lg px-6 pt-6">
      ...
      <div class="flex flex-col gap-5">
        ...
        <div class="flex flex-col gap-1.5">
          ...
          <textarea
            ...
            rows="5"
            class="resize-none rounded-xl border-2 border-gray-300 bg-white px-4 py-3 text-gray-900 outline-none transition-colors placeholder:text-gray-400 focus:border-blue-600"
          />
        </div>
      </div>
